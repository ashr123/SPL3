					...
					do
					{
						...
						if (line.contains("BROADCAST"))
						{
							if (!serverBroadcast.get(broadcastIndex).equals("*"))
							{
								...
								if (serverBroadcast.get(broadcastIndex).equals("NO BROADCAST SHOULD BE RECEIVED"))
								{
									Assert.fail();
								}
						}
